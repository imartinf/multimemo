...
responses-debug: requirements
	...
	$(PYTHON_INTERPRETER) src/data/make_responses_dataset.py $(EXP_NAME) data/raw/memento_val_data.json data/processed $(PROMPT_NAME) -temperature 1.5 -debug True
##	$(PYTHON_INTERPRETER) src/data/make_responses_dataset.py $(EXP_NAME) data/raw/memento_test_data.json data/processed $(PROMPT_NAME) -temperature 1 -debug True
